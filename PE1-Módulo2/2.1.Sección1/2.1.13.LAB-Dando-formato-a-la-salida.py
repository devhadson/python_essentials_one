...
'''
# mi solución
print("Aprende", "Python", "para", "IA", sep="*")
print("Aprende", "Python", "para", "IA", sep=" * ", end=" * \n")
print("Aprende", "Python", "para", "IA" * 2, sep=" * *", end="* * \n")
print("Aprende", "Python", "para", "IA", sep="***", end="*** \n")
print("Aprende", "Python", "para", "IA", sep="* *", end=" * *\n")
print("Aprende", "Python", "para", "IA", end="*****")
...
print("  *****")
###################
print("como menos invocación de 'print()':")
###################
print("    *\n   * *\n  *   *\n *     *\n***   ***")
print("  *   *\n  *   *\n  *****")
###################
